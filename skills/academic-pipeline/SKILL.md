...
description: "Orchestrator for the full academic research pipeline: research -> write -> integrity check -> review -> revise -> re-review -> re-revise -> final integrity check -> finalize. Coordinates deep-research, academic-paper, and academic-paper-reviewer into a seamless 10-stage workflow with mandatory integrity verification, two-stage peer review, and reproducible quality gates. Triggers on: academic pipeline, research to paper, full paper workflow, paper pipeline, end-to-end paper, research-to-publication, complete paper workflow, 学术流水线, 从研究到论文, 完整论文流程, 端到端论文, 论文流水线."
metadata:
  version: "3.7.0"
...
**简体中文 / 繁體中文**: 学术流水线, 从研究到论文, 完整论文流程, 端到端论文, 论文流水线, 學術流水線, 從研究到論文, 完整論文流程, 端到端論文, 論文流水線
...
| `references/skills_chain_guide.md` | Complete end-to-end skills chain for the full paper lifecycle (Stage 0-9) |
