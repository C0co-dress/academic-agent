...
- **Writing Quality Check** — The report compiler runs a writing quality checklist before finalizing: flags AI-typical overused terms, checks sentence/paragraph length variation, removes throat-clearing openers. Section F covers Chinese academic writing anti-patterns. See `academic-paper/references/writing_quality_check.md`.
...
**简体中文**: 研究, 深度研究, 文献回顾, 文献探讨, 系统性回顾, 荟萃分析, 证据综整, 事实查核, 研究方法, 学术分析, 政策分析, 引导我的研究, 帮我厘清, 监测这个主题, 设定追踪
